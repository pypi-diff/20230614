# Comparing `tmp/invenio-accounts-3.0.0.tar.gz` & `tmp/invenio-accounts-3.0.1.tar.gz`
...
### Comparing `invenio-accounts-3.0.0/.editorconfig` & `invenio-accounts-3.0.1/.editorconfig`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/.github/workflows/i18n-pull.yml` & `invenio-accounts-3.0.1/.github/workflows/i18n-pull.yml`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/.github/workflows/i18n-push.yml` & `invenio-accounts-3.0.1/.github/workflows/i18n-push.yml`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/.github/workflows/pypi-publish.yml` & `invenio-accounts-3.0.1/.github/workflows/pypi-publish.yml`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/.github/workflows/tests.yml` & `invenio-accounts-3.0.1/.github/workflows/tests.yml`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/.tx/config` & `invenio-accounts-3.0.1/.tx/config`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/AUTHORS.rst` & `invenio-accounts-3.0.1/AUTHORS.rst`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/CHANGES.rst` & `invenio-accounts-3.0.1/CHANGES.rst`
...
### Comparing `invenio-accounts-3.0.0/CONTRIBUTING.rst` & `invenio-accounts-3.0.1/CONTRIBUTING.rst`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/LICENSE` & `invenio-accounts-3.0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/MANIFEST.in` & `invenio-accounts-3.0.1/MANIFEST.in`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/PKG-INFO` & `invenio-accounts-3.0.1/PKG-INFO`
...
### Comparing `invenio-accounts-3.0.0/README.rst` & `invenio-accounts-3.0.1/README.rst`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/docs/Makefile` & `invenio-accounts-3.0.1/docs/Makefile`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/docs/admin.png` & `invenio-accounts-3.0.1/docs/admin.png`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/docs/api.rst` & `invenio-accounts-3.0.1/docs/api.rst`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/docs/conf.py` & `invenio-accounts-3.0.1/docs/conf.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/docs/configuration.rst` & `invenio-accounts-3.0.1/docs/configuration.rst`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/docs/index.rst` & `invenio-accounts-3.0.1/docs/index.rst`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/docs/make.bat` & `invenio-accounts-3.0.1/docs/make.bat`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/__init__.py` & `invenio-accounts-3.0.1/invenio_accounts/__init__.py`
...
### Comparing `invenio-accounts-3.0.0/invenio_accounts/admin.py` & `invenio-accounts-3.0.1/invenio_accounts/admin.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/alembic/62efc52773d4_create_useridentity_table.py` & `invenio-accounts-3.0.1/invenio_accounts/alembic/62efc52773d4_create_useridentity_table.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/alembic/843bc79c426f_create_accounts_branch.py` & `invenio-accounts-3.0.1/invenio_accounts/alembic/843bc79c426f_create_accounts_branch.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/alembic/9848d0149abd_create_accounts_tables.py` & `invenio-accounts-3.0.1/invenio_accounts/alembic/9848d0149abd_create_accounts_tables.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/alembic/999dcbd19ace_users_versioning.py` & `invenio-accounts-3.0.1/invenio_accounts/alembic/999dcbd19ace_users_versioning.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/alembic/dfbdf43a3e96_separate_login_info.py` & `invenio-accounts-3.0.1/invenio_accounts/alembic/dfbdf43a3e96_separate_login_info.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/alembic/e12419831262_add_new_columns_on_sessionactivity.py` & `invenio-accounts-3.0.1/invenio_accounts/alembic/e12419831262_add_new_columns_on_sessionactivity.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/alembic/eb9743315a9d_add_userprofile.py` & `invenio-accounts-3.0.1/invenio_accounts/alembic/eb9743315a9d_add_userprofile.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/alembic/f2522cdd5fcd_change_accountsrole_primary_key_to_string.py` & `invenio-accounts-3.0.1/invenio_accounts/alembic/f2522cdd5fcd_change_accountsrole_primary_key_to_string.py`
...
### Comparing `invenio-accounts-3.0.0/invenio_accounts/api.py` & `invenio-accounts-3.0.1/invenio_accounts/api.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/cli.py` & `invenio-accounts-3.0.1/invenio_accounts/cli.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/config.py` & `invenio-accounts-3.0.1/invenio_accounts/config.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/context_processors/jwt.py` & `invenio-accounts-3.0.1/invenio_accounts/context_processors/jwt.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/datastore.py` & `invenio-accounts-3.0.1/invenio_accounts/datastore.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/errors.py` & `invenio-accounts-3.0.1/invenio_accounts/errors.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/ext.py` & `invenio-accounts-3.0.1/invenio_accounts/ext.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/forms.py` & `invenio-accounts-3.0.1/invenio_accounts/forms.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/hash.py` & `invenio-accounts-3.0.1/invenio_accounts/hash.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/models.py` & `invenio-accounts-3.0.1/invenio_accounts/models.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/profiles/__init__.py` & `invenio-accounts-3.0.1/invenio_accounts/profiles/__init__.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/profiles/dicts.py` & `invenio-accounts-3.0.1/invenio_accounts/profiles/dicts.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/profiles/schemas.py` & `invenio-accounts-3.0.1/invenio_accounts/profiles/schemas.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/proxies.py` & `invenio-accounts-3.0.1/invenio_accounts/proxies.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/sessions.py` & `invenio-accounts-3.0.1/invenio_accounts/sessions.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/signals.py` & `invenio-accounts-3.0.1/invenio_accounts/signals.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/tasks.py` & `invenio-accounts-3.0.1/invenio_accounts/tasks.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/invenio_accounts/_macros.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/invenio_accounts/_macros.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/invenio_accounts/change_password.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/invenio_accounts/change_password.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/invenio_accounts/forgot_password.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/invenio_accounts/forgot_password.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/invenio_accounts/login_user.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/invenio_accounts/login_user.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/invenio_accounts/register_user.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/invenio_accounts/register_user.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/invenio_accounts/reset_password.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/invenio_accounts/reset_password.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/invenio_accounts/send_confirmation.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/invenio_accounts/send_confirmation.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/invenio_accounts/settings/security.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/invenio_accounts/settings/security.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/semantic-ui/invenio_accounts/_macros.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/semantic-ui/invenio_accounts/_macros.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/semantic-ui/invenio_accounts/change_password.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/semantic-ui/invenio_accounts/change_password.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/semantic-ui/invenio_accounts/forgot_password.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/semantic-ui/invenio_accounts/forgot_password.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/semantic-ui/invenio_accounts/login_user.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/semantic-ui/invenio_accounts/login_user.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/semantic-ui/invenio_accounts/register_user.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/semantic-ui/invenio_accounts/register_user.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/semantic-ui/invenio_accounts/reset_password.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/semantic-ui/invenio_accounts/reset_password.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/semantic-ui/invenio_accounts/send_confirmation.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/semantic-ui/invenio_accounts/send_confirmation.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/templates/semantic-ui/invenio_accounts/settings/security.html` & `invenio-accounts-3.0.1/invenio_accounts/templates/semantic-ui/invenio_accounts/settings/security.html`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/testutils.py` & `invenio-accounts-3.0.1/invenio_accounts/testutils.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/af/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/af/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/af/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/af/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ar/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/ar/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ar/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/ar/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/bg/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/bg/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/bg/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/bg/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ca/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/ca/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ca/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/ca/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/cs/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/cs/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/cs/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/cs/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/da/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/da/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/da/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/da/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/de/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/de/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/de/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/de/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/el/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/el/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/el/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/el/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/es/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/es/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/es/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/es/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/et/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/et/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/et/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/et/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/et_EE/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/et_EE/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/et_EE/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/et_EE/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/fa/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/fa/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/fa/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/fa/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/fr/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/fr/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/fr/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/fr/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/gl/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/gl/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/gl/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/gl/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/hr/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/hr/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/hr/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/hr/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/hu/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/hu/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/hu/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/hu/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/it/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/it/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/it/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/it/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ja/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/ja/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ja/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/ja/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ka/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/ka/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ka/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/ka/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/lt/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/lt/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/lt/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/lt/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/messages.pot` & `invenio-accounts-3.0.1/invenio_accounts/translations/messages.pot`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/no/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/no/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/no/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/no/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/pl/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/pl/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/pl/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/pl/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/pt/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/pt/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/pt/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/pt/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ro/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/ro/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ro/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/ro/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ru/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/ru/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/ru/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/ru/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/rw/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/rw/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/rw/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/rw/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/sk/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/sk/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/sk/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/sk/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/sv/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/sv/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/sv/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/sv/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/tr/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/tr/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/tr/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/tr/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/uk/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/uk/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/uk/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/uk/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/zh_CN/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/zh_CN/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/zh_CN/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/zh_CN/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/zh_TW/LC_MESSAGES/messages.mo` & `invenio-accounts-3.0.1/invenio_accounts/translations/zh_TW/LC_MESSAGES/messages.mo`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/translations/zh_TW/LC_MESSAGES/messages.po` & `invenio-accounts-3.0.1/invenio_accounts/translations/zh_TW/LC_MESSAGES/messages.po`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/utils.py` & `invenio-accounts-3.0.1/invenio_accounts/utils.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/views/__init__.py` & `invenio-accounts-3.0.1/invenio_accounts/views/__init__.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/views/rest.py` & `invenio-accounts-3.0.1/invenio_accounts/views/rest.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/views/security.py` & `invenio-accounts-3.0.1/invenio_accounts/views/security.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts/views/settings.py` & `invenio-accounts-3.0.1/invenio_accounts/views/settings.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts.egg-info/PKG-INFO` & `invenio-accounts-3.0.1/invenio_accounts.egg-info/PKG-INFO`
...
### Comparing `invenio-accounts-3.0.0/invenio_accounts.egg-info/SOURCES.txt` & `invenio-accounts-3.0.1/invenio_accounts.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/invenio_accounts.egg-info/entry_points.txt` & `invenio-accounts-3.0.1/invenio_accounts.egg-info/entry_points.txt`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/requirements-devel.txt` & `invenio-accounts-3.0.1/requirements-devel.txt`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/run-tests.sh` & `invenio-accounts-3.0.1/run-tests.sh`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/setup.cfg` & `invenio-accounts-3.0.1/setup.cfg`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/conftest.py` & `invenio-accounts-3.0.1/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/e2e/conftest.py` & `invenio-accounts-3.0.1/tests/e2e/conftest.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/e2e/e2e_basic_test.py` & `invenio-accounts-3.0.1/tests/e2e/e2e_basic_test.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_admin.py` & `invenio-accounts-3.0.1/tests/test_admin.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_cli.py` & `invenio-accounts-3.0.1/tests/test_cli.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_forms.py` & `invenio-accounts-3.0.1/tests/test_forms.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_hash.py` & `invenio-accounts-3.0.1/tests/test_hash.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_invenio_accounts.py` & `invenio-accounts-3.0.1/tests/test_invenio_accounts.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_models.py` & `invenio-accounts-3.0.1/tests/test_models.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_schemas.py` & `invenio-accounts-3.0.1/tests/test_schemas.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_sessions.py` & `invenio-accounts-3.0.1/tests/test_sessions.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_tasks.py` & `invenio-accounts-3.0.1/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_template_context_processors.py` & `invenio-accounts-3.0.1/tests/test_template_context_processors.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_token_duration.py` & `invenio-accounts-3.0.1/tests/test_token_duration.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_utils.py` & `invenio-accounts-3.0.1/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_validated_dicts.py` & `invenio-accounts-3.0.1/tests/test_validated_dicts.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_views.py` & `invenio-accounts-3.0.1/tests/test_views.py`

 * *Files identical despite different names*

### Comparing `invenio-accounts-3.0.0/tests/test_views_rest.py` & `invenio-accounts-3.0.1/tests/test_views_rest.py`
