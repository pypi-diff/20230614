# Comparing `tmp/configuraptor-1.1.0.tar.gz` & `tmp/configuraptor-1.1.1.tar.gz`
...
### Comparing `configuraptor-1.1.0/tests/test_toml_dataclass.py` & `configuraptor-1.1.1/tests/test_toml_dataclass.py`
