# Comparing `tmp/omkar_temp_mail-1.0.1.tar.gz` & `tmp/omkar-temp-mail-1.0.2.tar.gz`
...
## Comparing `omkar_temp_mail-1.0.1.tar` & `omkar-temp-mail-1.0.2.tar`
...
### Comparing `omkar_temp_mail-1.0.1/PKG-INFO` & `omkar-temp-mail-1.0.2/PKG-INFO`
