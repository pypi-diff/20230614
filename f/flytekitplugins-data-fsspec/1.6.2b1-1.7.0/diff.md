# Comparing `tmp/flytekitplugins-data-fsspec-1.6.2b1.tar.gz` & `tmp/flytekitplugins-data-fsspec-1.7.0.tar.gz`
...
## Comparing `flytekitplugins-data-fsspec-1.6.2b1.tar` & `flytekitplugins-data-fsspec-1.7.0.tar`
...
### Comparing `flytekitplugins-data-fsspec-1.6.2b1/PKG-INFO` & `flytekitplugins-data-fsspec-1.7.0/PKG-INFO`
...
### Comparing `flytekitplugins-data-fsspec-1.6.2b1/flytekitplugins_data_fsspec.egg-info/PKG-INFO` & `flytekitplugins-data-fsspec-1.7.0/flytekitplugins_data_fsspec.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-data-fsspec-1.6.2b1/setup.py` & `flytekitplugins-data-fsspec-1.7.0/setup.py`
