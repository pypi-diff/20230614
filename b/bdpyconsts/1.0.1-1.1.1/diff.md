# Comparing `tmp/bdpyconsts-1.0.1.tar.gz` & `tmp/bdpyconsts-1.1.1.tar.gz`
...
## Comparing `bdpyconsts-1.0.1.tar` & `bdpyconsts-1.1.1.tar`
...
### Comparing `bdpyconsts-1.0.1/PKG-INFO` & `bdpyconsts-1.1.1/setup.cfg`
